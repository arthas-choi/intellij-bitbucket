...
class BitbucketChooseAccountDialog(project: Project?, parentComponent: Component?,
                                   accounts: Collection<BitbucketAccount>,
  ...
  private val accountsList: JBList<BitbucketAccount> = JBList<BitbucketAccount>(accounts).apply {
    selectionMode = ListSelectionModel.SINGLE_SELECTION
    cellRenderer = object : ColoredListCellRenderer<BitbucketAccount>() {
      override fun customizeCellRenderer(list: JList<out BitbucketAccount>,
                                         value: BitbucketAccount,
                                         index: Int,
                                         selected: Boolean,
                                         hasFocus: Boolean) {
        append(value.name)
  ...
  val account: BitbucketAccount get() = accountsList.selectedValue
