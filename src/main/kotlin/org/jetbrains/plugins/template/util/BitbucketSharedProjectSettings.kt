...
class BitbucketSharedProjectSettings : PersistentStateComponentWithModificationTracker<BitbucketSharedProjectSettings.SettingsState> {
  ...
  override fun loadState(state: BitbucketSharedProjectSettings.SettingsState) {
    this.state = state
  }

  companion object {
    @JvmStatic
    fun getInstance(project: Project) = project.service<BitbucketSharedProjectSettings>()
  }
}
