...
class CachingBitbucketUserAvatarLoader : Disposable {
  private val LOG = logger<CachingBitbucketUserAvatarLoader>()
  ...
  companion object {
    @JvmStatic
    fun getInstance(): CachingBitbucketUserAvatarLoader = service()
