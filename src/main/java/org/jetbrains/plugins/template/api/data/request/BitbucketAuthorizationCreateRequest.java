...
public class BitbucketAuthorizationCreateRequest {
  @NotNull private final List<String> scopes;

  @Nullable private final String note;
  @Nullable private final String noteUrl;

  public BitbucketAuthorizationCreateRequest(@NotNull List<String> scopes, @Nullable String note, @Nullable String noteUrl) {
    this.scopes = scopes;
    this.note = note;
