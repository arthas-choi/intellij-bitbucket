...
import static org.jetbrains.plugins.template.util.GithubAuthData.AuthType;

@State(name = "GithubSettings", storages = {
  @Storage(value = "github.xml"),
  @Storage(value = "github_settings.xml", deprecated = true)
})
public class BitbucketSettings implements PersistentStateComponent<BitbucketSettings.State> {
  ...
  /**
   * @deprecated {@link BitbucketAuthenticationManager}
   */
  @Deprecated
  @Nullable
  ...
  public boolean isAuthConfigured() {
    return BitbucketAuthenticationManager.getInstance().hasAccounts();
  }
