...
public class BitbucketUrlUtil {
  ...
  public static String getApiUrl(@NotNull String urlFromSettings) {
    return BitbucketServerPath.from(urlFromSettings).toApiUrl();
  }
   ...
   */
  @Nullable
  public static BBRepositoryPath getUserAndRepositoryFromRemoteUrl(@NotNull String remoteUrl) {
    ...
    return new BBRepositoryPath(username, reponame);
  }
   ...
   *
   * @deprecated {@link org.jetbrains.plugins.template.api.BBRepositoryCoordinates}
   */
  @Deprecated
  @NotNull
  ...
  public static String makeGithubRepoUrlFromRemoteUrl(@NotNull String remoteUrl, @NotNull String host) {
    BBRepositoryPath repo = getUserAndRepositoryFromRemoteUrl(remoteUrl);
    if (repo == null) {
      return null;
    }
