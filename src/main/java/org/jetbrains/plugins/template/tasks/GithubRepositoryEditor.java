 ...
 */
public class GithubRepositoryEditor extends BaseRepositoryEditor<BitbucketRepository> {
  ...
  public GithubRepositoryEditor(final Project project, final BitbucketRepository repository, Consumer<? super BitbucketRepository> changeListener) {
  ...
  private void generateToken() {
    BitbucketLoginDialog dialog = new BitbucketLoginDialog(BitbucketApiRequestExecutor.Factory.getInstance(), myProject);
